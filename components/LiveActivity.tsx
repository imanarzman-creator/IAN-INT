...
const activities = [
  ...
  { text: "Agent Sarah K. requested clearance for Double Agent Protocol", time: "Just now", type: "signup" },
  ...
  { text: "System Alert: High volume of Double Agent Protocol requests", time: "Live", type: "alert" },
  ...
  { text: "Marcus L. initialized Double Agent Protocol sequence", time: "1 min ago", type: "signup" },
  ...
  { text: "Access Granted: Double Agent Protocol briefing sent to user in KL", time: "3 mins ago", type: "purchase" },
  ...
  { text: "Double Agent Protocol: Early Bird slots are filling fast", time: "Alert", type: "alert" },
